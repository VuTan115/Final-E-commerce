...
class MapUiBodyState extends State<MapUiBody> {
  ...
  Widget _myLocationTrackingModeCycler() {
    final MyLocationTrackingMode nextType = MyLocationTrackingMode
        .values[(_myLocationTrackingMode.index + 1) % MyLocationTrackingMode.values.length];
    return FlatButton(
        ...
        setState(() {
          if (_customWMSLayerEnabled == false) {
            ...
            mapController.addWMSLayer(
                "custom-layer", "https://a.tile.opentopomap.org/{z}/{x}/{y}.png", 256);
          } else {
